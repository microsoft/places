...
if( $doc2 )
{
	...
	#
	# Make sure ID_CAP_SENSORS exists
	#	
	$sensorselement2 = $capsnode2.SelectSingleNode("//Capability[@Name = 'ID_CAP_SENSORS']", $ns2)
	if( $sensorselement2 -eq $null )
	{
		Write-Host "Adding ID_CAP_SENSORS capability"
		$sensorselement2 = $doc2.CreateElement("ns2:Capability", $ns2.LookupNamespace("ns2"))
		$nameattribute4 = $doc2.CreateAttribute("Name")
		$nameattribute4.Value = "ID_CAP_SENSORS"
		$sensorselement2.Attributes.Append($nameattribute4)
		$capsnode2.AppendChild($sensorselement2)
	}
...
$props.Add("Name", "Microsoft Visual C++ 2013 Runtime Package for Windows Phone")
